...
def save_json(json_obj, json_path, append_if_exists=False,
              overwrite_if_exists=False, unique_fn_if_exists=False):
    """Saves a json file
    ...
    Arguments:
        ...
        unique_fn_if_exsists: bool, appends the current date and time to the
            file name if the target file exists already. Modification: I made
            this to False such that each time the influence functions records
            will be overwritten.
    """
